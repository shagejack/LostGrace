...
public class ItemPropertyOverridesRegistry {
    ...
    public static void propertyOverrideRegistry(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(AllItems.blackKnife.get(), LostGrace.asResource("invisible"), (itemStack, clientLevel, livingEntity, entityId) -> BlackKnife.isInvisible(itemStack) ? 1.0F : 0.0F);
        });
    }
